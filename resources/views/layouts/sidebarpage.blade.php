        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Cheesy</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                      ...
                      <ul class="menu-sub">
                        <li class="menu-item">
                          <a href="pages-account-settings-account.html" class="menu-link">
                            <div data-i18n="Account">Nota de venta</div>
                          </a>
                        </li>
                        <li class="menu-item">
                          <a href="pages-account-settings-notifications.html" class="menu-link">
                            <div data-i18n="Notifications">Pagos</div>
                          </a>
                        </li>
                        </li>
                      </ul>
              ...
              <li class="menu-item">
                  ...
                  <div data-i18n="Authentications">Administradores</div>
                  </a>
              </li>
              <li class="menu-item">
                  <a href="javascript:void(0);" class="menu-link">
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  © 2/2023 Cesar Alejandro Caballero Caballero 
                </div>
                <div>
                  <a href="#"> Sistemas de informacion 2</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
